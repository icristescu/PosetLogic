...
\label{lem:completeness_causal_pair}
  For each pair of sequential dependent transitions $G_1\overset{n_1,p_1}{\Rightarrow}G\overset{n_2,p_2}{\Rightarrow} G_2$ there exists a causal pair $P_1\overset{m_1,p_1}{\Rightarrow} M\overset{m_2,p_2}{\Rightarrow} P_2$ and a mono $m:M\emb G$ such that
\begin{mdframed}[backgroundcolor=blue!20]
  ...
  \begin{tikzpicture} %[scale=0.8]
    ...
    \draw [left hook->] (l1) --  (m1);
    \draw [left hook->] (r2) --  (m2);
    \draw [>=latex, ->] (m1) -- node [above,midway] {$n_1,p_1$} (m);
    \draw [>=latex, ->] (m) -- node [above,midway] {$n_2,p_2$} (m2);
    \draw [>=latex, ->] (l2) -- node [above,midway] {$m_2,p_2$} (r2);
    \draw [>=latex, ->] (l1) -- node [above,midway] {$m_1,p_1$}(l2);
  \end{tikzpicture}
  \]
\end{lemma}
\begin{proof}
...
\begin{remark}[Influence and causality in Kappa]
