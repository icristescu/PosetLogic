...
\DeclareMathOperator{\tagg}{tag}
\DeclareMathOperator{\untag}{untag}
\DeclareMathOperator{\card}{Card}

%% Encodings
\newcommand{\encc}[1]{\ensuremath{[\![#1]\!]}}
\newcommand{\enc}[1]{\encc{#1}} % Alias
\newcommand{\encr}[1]{\ensuremath{[\![#1]\!]}}
\newcommand{\den}[1]{\ensuremath{\langle{#1}\rangle}}
\newcommand{\maxconc}[1]{\ensuremath{\{#1\}}}
\newcommand{\minconc}[1]{\ensuremath{\{\{#1\}\}}}
